...
<link rel="stylesheet" href="<?= base_url()?>/assets/fontawesome/css/font-awesome.min.css">
  ...
  height: 100vh;
  background: url("https://margamandala.co.id/storage/assets/imgPhoto/tgATgsygWs8jLvsY9Hj29dBi6Q31LLxibyEDlKtA.jpg") 50% fixed;
...
<body>
  ...
  <form action="<?php echo base_url('login/proses_login')?>" class="login" method="post">
    ...
    <p class="title"><i class="" aria-hidden="true"></i> Gudang astra infra tamer</p>
