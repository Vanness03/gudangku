              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  ...
                  <select class="form-control" name="lokasi" style="margin-left:75px;width:20%;display:inline;">
                    ...
                    <option value="Serang timur">Serang timur</option>
                    <option value="Serang barat">Serang barat</option>
                    <option value="Merak">Merak</option>
                    <option value="Cilegon Timur">Cilegon Timur</option>
                    <option value="Cilegon Barat">Cilegon Barat</option>
                    <option value="Ciujung">Ciujung</option>
                    <option value="Cikande">Cikande</option>
                    <option value="Balaraja Timur">Balaraja Timur</option>
                    <option value="Balaraja Barat">Balaraja Barat</option>
